...
Elm.Console.make = function (_elm) {
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var stdin = $Native$Console.stdin;
   ...
   return _elm.Console.values = {_op: _op,log: log,error: error,fatal: fatal,stdin: stdin};
};
Elm.Native = Elm.Native || {};
...
Elm.Main.make = function (_elm) {
   ...
   A2($Task.andThen,$File.read("elm-stuff/exact-dependencies.json"),$Console.log),
   $Console.fatal));
